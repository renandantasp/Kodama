				...
				<div className='pt-4 text-xs lg:mx-[19%] lg:pt-[8.5em]'>
					<div className='flex w-full flex-col justify-start px-8 lg:flex-row lg:px-0'>
						<section className='flex flex-col '>
							...
							<div className='m-4 w-full lg:w-[55%]'>
					...
					<div className='hidden w-full flex-col justify-start px-8 lg:px-0 '>
						<section className=' flex flex-col items-center lg:w-full lg:flex-row '>
							...
							{/* <div className='m-4 w-full lg:hidden'>{media}</div>
							<div className='bg-red m-4 hidden w-full lg:w-[45%]'>{media}</div> */}
						</section>
						<section className=' flex flex-col items-center  lg:w-full lg:flex-row '>
							<div className='m-4 w-full lg:w-[55%]'>
								<div className='mb-8 flex flex-col items-center  lg:flex-row lg:justify-start'>
							...
							<div className='m-4 w-full lg:w-[45%]'> b</div>
						</section>
					</div>
				</div>
			</div>
